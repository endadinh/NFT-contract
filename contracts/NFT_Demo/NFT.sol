...
contract ERC721 is IERC721, Context, Ownable, IERC721Metadata {
    ...
    function _beforeTokenTransfer(
        ...
        //     "ERC721: transfer not owner token"
        // );
    }
    ...
    //     require(_owners[_tokenId] == address(0), "this token already exist");
    ...
    //     _beforeTokenTransfer(sender, recipient, tokenId);
...
contract SQFItem is ERC721 {
    ...
    mapping(uint256 => address) private weapons;
    ...
    function mint(address _to, string memory tokenURI_) public onlyOwner {
